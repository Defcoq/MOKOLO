(function() {
	...
	NewController.$inject = [
		'newsService', '$stateParams', 'cameraService', 'amazonS3Service', '$ionicLoading', '$window', '$state', 'fieldEditor', 'listsService', '$ionicPopup', '_', 'ENV'];
	...
	function NewController(
		...
		function changeString(field) {
			fieldEditor.showTextFieldEditor({
				...
				var obj = {};
				obj[field] = value;
				newsService.saveItem(vm.item.$id, obj);
			});
		}
