(function() {
	...
	newsService.$inject = ['firebaseDb', '_', '$firebaseArray', '$firebaseObject', 'listsService'];

	/* @ngInject */
	function newsService(firebaseDb, _, $firebaseArray, $firebaseObject, listsService) {
		var collectionName = 'news';
		var query = firebaseDb.child(collectionName);
		var news = $firebaseArray(query);
