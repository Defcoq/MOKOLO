(function() {
	...
	servicesService.$inject = ['firebaseDb', '_', '$firebaseArray', '$firebaseObject', 'listsService'];

	/* @ngInject */
	function servicesService(firebaseDb, _, $firebaseArray, $firebaseObject, listsService) {
		var collectionName = 'services';
		var query = firebaseDb.child(collectionName);
		var services = $firebaseArray(query);
