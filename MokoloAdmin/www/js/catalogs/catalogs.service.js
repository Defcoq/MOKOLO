(function() {
	...
	catalogsService.$inject = ['firebaseDb', '_', '$firebaseArray', '$firebaseObject', 'listsService'];

	/* @ngInject */
	function catalogsService(firebaseDb, _, $firebaseArray, $firebaseObject, listsService) {
		var collectionName = 'catalogs';
		var query = firebaseDb.child(collectionName);
		var catalogs = $firebaseArray(query);
